...
public class Inbox extends AsyncTask<Object, Void, String> {
    ...
    protected void onPostExecute() {
        sucelje.prenesi_conversation(userIds, names, lastnames, messages, senderIds, timestamps, flags, br_ljudi,  error_info);
    }
    ...
    public interface prenesi{
    	void prenesi_conversation(List<String> userIds, List<String> names, List<String> lastnames, List<String> messages, List<String> SenderIds, List<String> timestamps, List<Integer> flags, int broj_ljudi, String error);
    }
